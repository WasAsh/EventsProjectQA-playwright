...
Call log:
  ...
  - waiting for locator('main article').first()
    5 × locator resolved to <article id="event-card" data-testid="event-card" class="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow group flex flex-col">…</article>
